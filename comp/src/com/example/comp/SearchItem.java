...
public class SearchItem extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new HttpAsyncTask().execute("http://ihome.ust.hk/~sraghuraman/cgi-bin/fetch-item.php", category, getIntent().getExtras().getString("sort-field"), getIntent().getExtras().getString("sort-field") );
		else
		{
